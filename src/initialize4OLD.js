...
instance.data.onRectangleOver = (e) => {
    true ? console.log("onRectangleOver") : null;
    ...
    buttonMove.on('pointerover', instance.data.controlOver, {
        ...
        .on('pointerdown', () => {    
           // instance.data.onDragStartNew(buttonMove,this,instance.data.inputModeEnum.move);
            //alsoInvokeMe(); 
            console.log("pointerdown:",buttonMove,this,instance.data.inputModeEnum.move);   
            buttonMove.alpha = 0.5;
            instance.data.dragController = buttonMove;
            instance.data.currentRectangle = this;
            instance.data.startPosition = new PIXI.Point().copyFrom(this.position)
            instance.data.inputMode = instance.data.inputModeEnum.move
            app.stage.on('pointermove', instance.data.onDragMoveNew);
       });
    //console.log("add ButtonMove to container", buttonMove.x,buttonMove.y, this, e, e.target, e.target.parent, instance.data.mainContainer, buttonMove);
    e.target.parent.addChild(buttonMove);
    ...
    buttonScale.on('pointerover', instance.data.controlOver, {
        ...
        .on('pointerdown', () => {    
            instance.data.onDragStartNew(buttonScale,this,instance.data.inputModeEnum.move);
            //alsoInvokeMe();    
       });

    e.target.parent.addChild(buttonScale);
